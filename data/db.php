...
$db = [
    ...
    new Category('Catnip', "catnip.jpg", 'Lorem ipsum sit amet', 8.60, '2022-03-02', 'Gatti',
        ['alimentazione']),
    new Category('Ciotola in acciaio', "ciotola.jpg", 'Lorem ipsum sit amet', 12.60, '2022-07-05', 'Gatti',
        ['Strumenti', 'idratazione', 'alimentazione']),
    new Category('Croccantini per gatti', "croccantini_gatto.jpg", 'Lorem ipsum sit amet', 10.60, '2022-03-11', 'Gatti',
        ['alimentazione', 'cibo solido']),
    new Category('Guinzaglio', "guinzaglio.jpg", 'Lorem ipsum sit amet', 7.30, '2022-03-02', 'Cani',
        ['svago', 'quotidianità']),
